Template.demo.rendered = function() {
    ...
    Meteor.subscribe('images', function() {
        //imagesList.forEach(function(mongoDocument) {
        //    console.log(currentDocuments[mongoDocument._id]);
        //    if(typeof currentDocuments[mongoDocument._id] === 'undefined') {
        //        currentDocuments.push(mongoDocument._id);
        //    }
        //
        //    if(currentDocuments.length < dotsCount) {
        //        return false;
        //    }
        //});

        //for (var i = 0; i < dotsCount; i++) {
        //    dotsHtml += "<div class='dot'><img src='http://www.placehold.it/120x120'></div>";
        //}
        ...
        $container
            ...
            .velocity(containerAnimationMap, { duration: 800, loop: true, delay: 3250 });

        /* Animate the dots. */
        var addDot = function(dot) {
            if (isWebkit) {
                dot.css("boxShadow", "0px 0px 4px 0px #4bc2f1");
            }
            ...
            dot
                ...
                .velocity("reverse", { easing: "easeInOutBack" })
        ...
        var imagesList = images.find();
        imagesList.observeChanges({
            added: function(id, document) {
                if(id !== null && document !== null) {
                    var dot = $('<div class="dot customimg" data-imageid="' + id + '">'+ '<img src="' + document.image + '">' +'</div>');
                    addDot(dot);
                }
            },
            ...
            removed: function(id) {
                if(id !== null) {
                    $("div[data-imageid='" + id +"']").velocity("stop").remove();
                }
            }
        });
    });
